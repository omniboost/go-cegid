...
type Entry struct {
	...
	TYPECPTE            string `fixed:"31,31"`
	AUXILIAIREOUSECTION string `fixed:"32,48"`
	...
	MONTANT2            string `fixed:"176,195"`
	MONTANT3            string `fixed:"196,215"`
